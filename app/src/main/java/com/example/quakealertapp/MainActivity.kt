...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupDrawer() {
        ...
        navView.setNavigationItemSelectedListener {
            it.isChecked = true
            when (it.itemId){
                R.id.menu_main_item -> replaceFragment(MainFragment(),it.title.toString())
                R.id.menu_recommend_item -> replaceFragment(RecommendationFragment(),it.title.toString())
                R.id.menu_about_item -> replaceFragment(AboutFragment(),it.title.toString())
            }
            true
        }
    }
